...
// transaction information
    ...
    void init(const size_t aw_delay, const size_t w_delay , const size_t b_delay, const size_t ar_delay, const size_t r_delay, const size_t mem_base_addr, uint8_t* const mem);
...
template <typename ADDRT, typename DATAT>
void axi_mem<ADDRT, DATAT>::init(const size_t aw_delay, const size_t w_delay , const size_t b_delay, const size_t ar_delay, const size_t r_delay, const size_t mem_base_addr, uint8_t* const mem)
{
